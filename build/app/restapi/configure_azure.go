...
//go:generate swagger generate server --target ../../app --name Azure --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/azure/build/templates --principal interface{}

func configureFlags(api *operations.AzureAPI) {
...
func configureAPI(api *operations.AzureAPI) http.Handler {
